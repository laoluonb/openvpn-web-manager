...
class DemoAgent:
    def __init__(self):
        ...
        self.update_state = {
            ...
            "manager_version": "1.2.13-test-demo",
            "openvpn_version": "OpenVPN 2.6 demo",
        }
        self.update_check = {
            "current_manager_version": "1.2.13-test-demo",
            "latest_manager_version": "v1.2.13-test-demo",
            ...
            "release_name": "v1.2.13-test：在线更新验证版",
            "release_url": "https://github.com/laoluonb/openvpn-web-manager/releases/tag/v1.2.13-test",
